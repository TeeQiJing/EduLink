...
public class Educator {
    ...
    public Educator(String username, String email, String password, String registration_date, String login_date, int xp, String avatar, String user_bio, DocumentReference  organization, Map<String, Integer> skill_point) {
